  ...
  return (
    <main className="bg-background h-screen">
      <div className="container p-[0.7rem]">
        <div className="flex items-center justify-center flex-col gap-10 pt-6">
          <Link
            href="/"
          ...
          <Card className="rounded-xl border bg-card text-card-foreground shadow p-6 w-full sm:w-2/3 lg:w-[42%]">
            {children}
          </Card>
        </div>
      </div>
